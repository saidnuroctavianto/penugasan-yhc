...
@section('title', 'Tambah Project Leader')
        ...
        <div class="page-titles">
            <div class="row">
                <div class="col-lg-8 col-md-6 col-12 align-self-center">
                    ...
                    <h1 class="mb-0 fw-bold">Tambah Project Leader</h1>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Tambah Project Leader</h4>
                            <h5 class="card-subtitle mb-3 pb-3 border-bottom">
                                silahkan input untuk menambahkan project leader
                            </h5>
                            <form autocomplete="off" method="POST" action="{{ route('project_leader.store') }}"
