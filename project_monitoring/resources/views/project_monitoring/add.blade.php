                ...
                <div class="col-lg-8 col-md-6 col-12 align-self-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 d-flex align-items-center">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                Tambah Project Monitoring
                            </li>
                        </ol>
                    </nav>
                    <h1 class="mb-0 fw-bold">Tambah Project Monitoring</h1>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Tambah Project Monitoring</h4>
                            <h5 class="card-subtitle mb-3 pb-3 border-bottom">
                                silahkan input untuk menambahkan project monitoring
                            </h5>
                            <form autocomplete="off" method="POST" action="{{ route('project_monitoring.store') }}">
                                @csrf
